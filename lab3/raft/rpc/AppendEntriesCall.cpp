...
AppendEntriesCall::AppendEntriesCall(raftService::RaftService::AsyncService* service,
...
void AppendEntriesCall::proceed(bool ok){
    ...
    if (state_ == State::CREATE) {
        ...
        service_->Requestappend_entries(
    ...
    if (state_ == State::PROCESS) {
        ...
        new AppendEntriesCall(service_, cq_, raft_);
